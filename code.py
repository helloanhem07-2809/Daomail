...
    if chon == "3.1":
        exec(requests.get("https://raw.githubusercontent.com/helloanhem07-2809/Daomail/main/8.py").text)
    elif chon == "3.2":
...
    elif chon == "4.8":
        exec(requests.get("https://raw.githubusercontent.com/helloanhem07-2809/Daomail/main/p.py").text)
...
    elif chon == "8":
        exec(requests.get("https://raw.githubusercontent.com/helloanhem07-2809/Daomail/main/10.py").text)
    else:
