...
""", style="bold white")
    ...
    if chon == "3.1":
        exec(requests.get("https://raw.githubusercontent.com/helloanhem07-2809/Daomail/main/8.py").text) # Xong (1)
    elif chon == "3.2":
        ...
        exec(requests.get("https://raw.githubusercontent.com/helloanhem07-2809/Daomail/main/p.py").text) # Xong (2)
        ...
        exec(requests.get("https://raw.githubusercontent.com/helloanhem07-2809/Daomail/main/10.py").text) #Xong (3)
    else:
